      ...
      const curatedCases = [
        {
          ...
          info: "[적용 법령: 형법 제314조(업무방해) 및 형법 제311조(모욕)]",
          summary: "학부모가 수업이 진행 중인 교실에 허락 없이 들어가 교사와 학생들 앞에서 교사에게 큰 소리로 욕설을 하고 행패를 부린 사례. 불특정 다수(학생들)가 있는 곳에서 교사의 사회적 평가를 저하시켰으므로 '모욕죄'가 성립할 수 있으며, 교사의 정상적인 수업 진행을 위력으로 방해하였으므로 '업무방해죄'가 인정될 수 있음."
        },
        {
          id: "edu-prec-002",
          title: "지속적이고 악의적인 심야 연락 및 협박 (정보통신망법 위반 및 협박)",
          info: "[적용 법령: 정보통신망법 제74조 및 형법 제283조(협박)]",
          summary: "학부모가 자녀에 대한 지도 방식에 불만을 품고 교사의 개인 휴대전화로 늦은 밤과 새벽 시간에 수십 차례에 걸쳐 공포심과 불안감을 유발하는 문자와 협박성 메시지를 보낸 사례. 정보통신망 이용촉진 및 정보보호 등에 관한 법률 위반(불안감 조성) 및 형법상 협박죄가 성립될 수 있음."
        },
        {
          id: "edu-prec-003",
          title: "학부모 단체 채팅방에서의 교사 비방 (정보통신망법상 명예훼손)",
          info: "[적용 법령: 정보통신망법 제70조(사이버 명예훼손)]",
          summary: "학부모가 다른 학부모들이 다수 참여한 카카오톡 단체 채팅방이나 네이버 밴드 등에 교사에 대한 허위 사실이나 과장된 비방글을 게시한 사례. 다수가 볼 수 있는 공간이므로 공연성이 인정되어 정보통신망법상 명예훼손으로 무겁게 처벌될 수 있음."
        },
        {
          id: "edu-prec-004",
          title: "학생에 의한 교사 폭행 및 상해 (상해 및 공무집행방해)",
          info: "[적용 법령: 형법 제257조(상해) 및 형법 제136조(공무집행방해)]",
          summary: "학생이 생활지도에 불만을 품고 교사를 밀치고 폭행하여 상해를 입힌 사례. 정당한 교육활동을 하던 교사를 폭행한 것은 단순 폭행을 넘어 상해죄가 적용될 수 있으며, 국공립학교 교원일 경우 공무집행방해죄가 성립될 수 있음."
        },
        {
          id: "edu-prec-005",
          title: "허위 아동학대 신고를 통한 교사 괴롭힘 (무고 및 공무집행방해)",
          info: "[적용 법령: 형법 제156조(무고)]",
          summary: "학부모가 정당한 훈육을 한 교사를 앙심을 품고 악의적으로 경찰에 아동학대로 허위 신고한 사례. 조사 결과 교사의 행위가 정당한 교육활동으로 밝혀질 경우, 타인이 형사처분을 받게 할 목적으로 허위 사실을 신고한 학부모는 형법상 무고죄로 처벌될 수 있음."
        }
      ];
