  ...
  async (input) => {
    const response = await generate({
      ...
      prompt: `
        ...
        특히 '2024년도 교원소청심사위원회 결정문집 제34집'의 최신 판례(징계, 재임용 거부, 직위해제 등 기타 불리한 처분)를 완벽하게 학습한 상태입니다.
        ...
        4. 소청심사 구제 방안: 부당한 징계나 직위해제, 재임용 거부 등 내부 처분을 받은 경우, '교원소청심사위원회 결정문집 제34집'을 참고하여 소청심사 청구를 통한 구제 가능성과 절차를 안내해 주세요.
